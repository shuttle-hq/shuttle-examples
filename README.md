...
Axum/Bevy | [Shuttle with Bevy](./axum/bevy-wasm) | A basic project template for a compiled Bevy WASM "Hello World" webpage | `cargo shuttle init --from shuttle-hq/shuttle-examples --subfolder axum/bevy-wasm` |
