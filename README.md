...
Axum | [oauth2-authentication](./axum/oauth2-authentication/) | Use Google Oauth2 to authenticate API endpoints | `cargo shuttle init --from shuttle-hq/shuttle-examples --subfolder axum/oauth2-authentication`
